...
describe('roundIsPossible', () => {
    test('13 green, 14 blue, 12 red', () => {
        expect(roundIsPossible('13 green, 14 blue, 12 red')).toBe(true)
    })
    test('1 green', () => {
        expect(roundIsPossible('1 green')).toBe(true)
    })
    test('8 green, 6 blue, 20 red', () => {
        expect(roundIsPossible('8 green, 6 blue, 20 red')).toBe(false)
    })
    test('1 green, 15 blue, 1 red', () => {
        expect(roundIsPossible('1 green, 15 blue, 1 red')).toBe(false)
    })
    test('14 green, 1 blue, 1 red', () => {
        expect(roundIsPossible('14 green, 1 blue, 1 red')).toBe(false)
    })
})
