/*
Notes how to solve this:
- for each row:
    - parse characters. For each complete number found:
...
describe('getLastDigitPosition', () => {
    const firstRow = '467..114..2.21'
    test('start at index 0', () => {
        expect(getLastDigitPosition(firstRow, 0)).toEqual(2)
    })

    test('start at index 5', () => {
        expect(getLastDigitPosition(firstRow, 5)).toEqual(7)
    })

    test('single digit', () => {
        expect(getLastDigitPosition(firstRow, 10)).toEqual(10)
    })

    test('number at end of string', () => {
        expect(getLastDigitPosition(firstRow, 12)).toEqual(13)
    })
})
