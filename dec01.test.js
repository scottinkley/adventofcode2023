...
describe('testing getCalibrationValueOf', () => {
...
describe('testing getCalibrationValueOf, taking into account digits in their english form', () => {
    test('two1nine', () => {
...
describe('testing getSumOfCalibrationValues', () => {
    test('the provided example, part 1', () => {
    ...
    test('the provided example, part 2', () => {
        ...
        zoneight234
        7pqrstsixteen`
        expect(getSumOfCalibrationValues(exampleDocument)).toEqual(281)
    })
})
